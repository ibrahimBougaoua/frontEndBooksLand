...
async function getUserInformation() {
    try {
      const response = await axios.get('http://127.0.0.1:5001/book/user/information/' + localStorage.getItem('email'));
...
const handleUpdateUserInformation = () => {
  axios.get('http://localhost:5001/book/user/update/' + localStorage.getItem('email'), {params : {fisrtname : this.state.fisrtname,lastname : this.state.lastname,email : this.state.email,password : this.state.password,sex : this.state.sex,age : this.state.age,country : this.state.country,telephone : this.state.telephone}})
