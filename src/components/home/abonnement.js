	...
	<div className="row no-gutters">
		...
		<div className="col-md-8">
			<div className="pl-2">
                ...
                <Link className="btn btn-success btn-sm position-relative" to={"/book/author/" + element} style={{bottom: "3px"}}>Show more</Link>
			</div>
		</div>
	</div>
    </div>
...
<div className="col-md-8">
  <div className="pl-2">
            ...
            <Link className="btn btn-success btn-sm position-relative float-right mr-2" to={"/book/single/" + element[0]} style={{top: "1vw"}}>Show more</Link>
  </div>
</div>
</div>
</div>
